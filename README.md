...
**Phase 1 of 8 complete.** The data pipeline is built and validated; the TypeScript
...
| 2 · Core maths | Kabsch, Rg, RMSD, contacts, SASA, contact order | ⏳ **Next** |
...
pnpm test     # TypeScript tests                        -> none yet (Phase 2)
pnpm typecheck
...
- `packages/core` is a placeholder; the maths lands in Phase 2.
...
│   └── tests/                51 tests
├── packages/
│   └── core/                 Pure biophysics maths (Phase 2)
├── data/
