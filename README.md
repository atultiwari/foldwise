...
**Phases 0–1 complete, Phase 2 under way.** The data pipeline and the geometry half
of the core maths are built and validated; there is no application yet.
...
| 2 · Core maths | Kabsch, Rg, RMSD, contacts, SASA, contact order | 🟡 **In progress** — 66 tests, SASA within 0.02% of FreeSASA |
| 3 · Trajectory engine | Calibrated coil, folding schedule, constrained morph | ⬜ Pending |
...
pnpm test       # core maths                             -> 66 passed
...
- `packages/core` has geometry, contacts, contact order and SASA. Hydrogen
  bonds, salt bridges and residue composition are still to come.
...
│       ├── src/              vec3, rg, kabsch, rmsd, contacts,
│       │                     contactOrder, sasa
