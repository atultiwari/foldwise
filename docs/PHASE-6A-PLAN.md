...
**Status:** planned, not started · **Inserted between** Phase 6 (editorial) and Phase 7 (ship)
**Estimated:** 4 weeks
...
|---|---|---|
| 6a.1 Explain layer | 4 d | Every read-out and structure explained at three levels; no hover-only affordances |
