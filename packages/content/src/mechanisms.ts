  ...
  // ── Imatinib ────────────────────────────────────────────────────────────
  {
    ...
    stages: [
      ...
      },
      {
        ...
        outcomes: [
          { when: { drug: "none" }, tone: "harm", state: "empty",
          ...
          { when: { kinase: "wt", drug: "imatinib" }, tone: "safe", state: "fits",
          ...
          { when: { kinase: "wt", drug: "ponatinib" }, tone: "safe", state: "fits",
          ...
          { when: { kinase: "t315i", drug: "imatinib" }, tone: "harm", state: "blocked",
  ...
  // ── Nirmatrelvir ────────────────────────────────────────────────────────
  {
    ...
    stages: [
      ...
      },
      {
        ...
        panel: { kind: "schematic", schematic: "lock" },
        outcomes: [
          { when: { drug: "no" }, tone: "harm", state: "empty",
